// @page Content — Browse content inventory, run AI analysis, manage posts
// Formerly "Analyze" — renamed to reflect the full content intelligence hub
"use client";
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Browse your content inventory, run AI analysis, and review insights.
          </p>
        </div>
        <Button asChild variant="outline" size="sm">
          <Link href="/content/import" className="flex items-center gap-2">
