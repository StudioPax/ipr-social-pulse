    ...
    <header className="sticky top-0 z-50 flex h-14 items-center border-b border-border bg-card px-4 sm:px-6">
        ...
        <SheetContent side="left" className="w-64 px-3 py-4">
          <SheetHeader className="px-3 pb-4">
            <SheetTitle className="flex items-center gap-2">
              ...
              <span className="font-logo font-bold text-xl tracking-[0px]">Meridian</span>
            </SheetTitle>
          </SheetHeader>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-baseline gap-2">
          <span className="font-logo font-bold text-xl tracking-[0px] text-foreground relative top-[2px]">Meridian</span>
